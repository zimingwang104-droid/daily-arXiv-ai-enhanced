...
### [3] [Jacobi polynomials on the simplex of Hermitian matrices and zonal spherical functions on partial flag manifolds](https://arxiv.org/abs/2607.25760)
*Teije Kuijper*
...
### [4] [Quadratic Killing tensors on some symmetric spaces of higher rank](https://arxiv.org/abs/2607.25075)
...
### [5] [Bonnet-Myers type theorems for $Q$-curvature on four-manifolds](https://arxiv.org/abs/2607.25343)
*Mingxiang Li*
...
### [6] [Gromov-Hausdorff Limits of Noncollapsed Kähler-Ricci Flows and the Geometry of Ricci Shrinkers](https://arxiv.org/abs/2607.25644)
...
### [7] [Combinatorial Yamabe flow on infinitely triangulated hyperbolic surfaces](https://arxiv.org/abs/2607.25691)
*Yuerong Bian,Xu Xu*
...
### [10] [Beurling Criteria for Reproducing Kernels](https://arxiv.org/abs/2607.25088)
...
### [11] [Grothendieck ideals of $\ell_\infty$](https://arxiv.org/abs/2607.25095)
...
### [12] [Some Central Digraphs and their Automorphisms](https://arxiv.org/abs/2607.24962)
*Jacob A. Siehler*
...
### [13] [On efficient graph covers and steered random walks](https://arxiv.org/abs/2607.25016)
...
### [14] [Schrijver Number Quasi-Tensorization and Multicolor Ramsey Bounds via Robust OR Polynomials](https://arxiv.org/abs/2607.25023)
...
### [15] [On the Irreducibility of the Differential Operators Associated to Random Walks in the Standard Euclidean Lattice](https://arxiv.org/abs/2607.25160)
...
### [16] [Nordhaus-Gaddum Inequalities for Dominating-Set Counts in Bipartite Graphs](https://arxiv.org/abs/2607.25188)
*T. N. Sanh*
...
### [17] [Diamond-free, claw-free cubic graphs are (1, 1, 2, 3)-packing colorable](https://arxiv.org/abs/2607.25198)
...
### [18] [Some Spectral Properties of the $B_α$ Matrix of a Graph](https://arxiv.org/abs/2607.25221)
*Garrett Kepler*
...
### [19] [Proper Hat-Guessing on Two-Spine Book Graphs](https://arxiv.org/abs/2607.25274)
*Yulin Zhai*
...
### [20] [Optimal coloring of $\{\mathrm{cap},\mathrm{even\ hole}\}$-free graphs with no short odd holes](https://arxiv.org/abs/2607.25396)
...
### [21] [On the Genus Polynomial of Cubic Graphs](https://arxiv.org/abs/2607.25410)
*Austin Ulrigg*
...
### [22] [A minimally nonperfectly divisible graph with a bisimplicial vertex](https://arxiv.org/abs/2607.25412)
*Lizhong Chen*
...
### [23] [A matroidal criterion for flow polytopes to be order polytopes](https://arxiv.org/abs/2607.25426)
...
### [24] [An Exact Obstruction to Uniform Average Mixing on $P_{11}$](https://arxiv.org/abs/2607.25490)
*Musung Kang*
...
### [25] [Projective Ore-Degree Conditions for Intersection Theorems in Vector Spaces](https://arxiv.org/abs/2607.25598)
...
### [26] [Extremal Families for the Erdős--Kleitman Problem: The Missing Constructions](https://arxiv.org/abs/2607.25611)
*Cheng Chi,Yan Wang*
...
### [27] [On the Realizability of Edge-Girth Sequences](https://arxiv.org/abs/2607.25629)
...
### [28] [On t-colorable k-plane drawings](https://arxiv.org/abs/2607.25682)
...
### [29] [A general-position problem for planar line arrangements](https://arxiv.org/abs/2607.25742)
*Oliver Roche-Newton*
...
### [30] [Constructing two completely independent spanning trees in the dual-cube](https://arxiv.org/abs/2607.25917)
...
### [31] [Asymptotically sharp bounds for affine subspace statistics in $\mathbb F_2^n$](https://arxiv.org/abs/2607.25920)
...
### [32] [Solution of Erdős problem $\# 443$](https://arxiv.org/abs/2607.25928)
*Stijn Cambie*
...
### [33] [The inverse reduction map of a symplectic column by decreasing the rank by one](https://arxiv.org/abs/2607.25976)
*Olga Azenhas*
...
### [34] [A Spectral Proof of the Hypergraph Moore Bound](https://arxiv.org/abs/2607.26028)
...
### [35] [Recent progress in graph theory using expansion](https://arxiv.org/abs/2607.26049)
*Richard Montgomery*
...
### [36] [Convex sets with vanishing relative width and the reverse Cheeger inequality](https://arxiv.org/abs/2607.25708)
...
### [37] [The Ultimate Ishii-Pastur Theorem for Whole-Line Ergodic Block Jacobi Operators](https://arxiv.org/abs/2607.25808)
...
### [38] [Pólya's Conjecture for the Neumann Laplacian on Euclidean Balls](https://arxiv.org/abs/2607.25958)
*Yutian Li*
...
### [39] [Free versions of the strong Szegő limit theorem](https://arxiv.org/abs/2607.25980)
...
### [40] [On the Wave of Klein-Gordon Type: Propagation Equation at a Boundary and Interior Observability](https://arxiv.org/abs/2607.24839)
*Siwar Ben Said*
...
### [41] [Diffusion stabilises time-periodic solutions in conservation laws coupled to a relaxation oscillator](https://arxiv.org/abs/2607.24994)
...
### [42] [The Navier-Stokes equations with dual-scale hereditary viscosity: supercritical norm inflation and global well-posedness in critical spaces](https://arxiv.org/abs/2607.25009)
*Bruno de Andrade*
...
### [43] [Inviscid Incompressible Limit for Degenerate Compressible Navier-Stokes Equations on Expanding Domains](https://arxiv.org/abs/2607.25028)
...
### [44] [An indefinite Coulomb interaction from the Steklov spectrum of perforated manifolds](https://arxiv.org/abs/2607.25211)
...
### [45] [Elliptic Regularity Theory in Barron Spaces and Applications to the Deep Ritz Method](https://arxiv.org/abs/2607.25100)
*Stephan Wojtowytsch*
...
### [46] [No Gelation and Global Existence for a Boltzmann Equation with Regularly Varying Mass-Exchange Rates](https://arxiv.org/abs/2607.25112)
...
### [47] [Propagation-Window Bounds in Degenerate Plant-Consumer Reaction-Diffusion Systems](https://arxiv.org/abs/2607.25149)
...
### [48] [Turbulent Flame Speed Can Increase under Curvature Smoothing](https://arxiv.org/abs/2607.25185)
...
### [49] [Homogenization of Time-Discrete Gradient Flows](https://arxiv.org/abs/2607.25206)
...
### [50] [Sharp rigidity for quasilinear Liouville equation on manifolds with nonnegative Ricci curvature](https://arxiv.org/abs/2607.25981)
*Xiaohan Cai*
...
### [51] [Double phase flow under Lavrentiev phenomenon](https://arxiv.org/abs/2607.25296)
*Yoshiki Kaiho*
...
### [52] [Semilinear damped wave equation on a compact Lie group with a non-autonomous forcing term](https://arxiv.org/abs/2607.25571)
...
### [53] [Global Dynamics of Trait-Structured Generalised Lotka-Volterra Systems with Trait-Independent Interactions](https://arxiv.org/abs/2607.25573)
...
### [54] [Well-posed homogenized strain-gradient models for linear elastodynamics and elastostatics in arbitrary periodic media](https://arxiv.org/abs/2607.25602)
...
### [55] [Finite-mass soliton-type rigidity and four-channel reduction for the three-dimensional nonradial focusing energy-critical nonlinear Schrödinger equation](https://arxiv.org/abs/2607.25735)
...
### [56] [Blow-up asymptotics for a critical Hartree-type Brézis--Nirenberg problem in dimension three](https://arxiv.org/abs/2607.25759)
*Yue Wu,Minbo Yang*
...
### [57] [Bisingular $(ρ,δ)$ pseudodifferential operators on products of compact Lie groups](https://arxiv.org/abs/2607.25821)
...
### [58] [Long-wave instability of periodic shear flows with constant magnetic field for the 2D resistive MHD equations](https://arxiv.org/abs/2607.25836)
...
### [59] [Sharp anisotropic $L^2$-Caffarelli-Kohn-Nirenberg inequalities associated with the Minkowski functional](https://arxiv.org/abs/2607.25876)
*Zhenzhen Wei*
...
### [60] [Many-point tropical relaxation and the Monge--Ampère equation](https://arxiv.org/abs/2607.25878)
...
### [61] [The Barron-Lipschitz Energy Gap and Depth Separation Phenomena in Scientific Machine Learning](https://arxiv.org/abs/2607.25905)
...
### [62] [Large Solutions for Fractional Laplacian on Infinite Cylindrical Domains](https://arxiv.org/abs/2607.25906)
...
### [63] [On the emergence of dead cores in elliptic systems with sublinear competitive interactions](https://arxiv.org/abs/2607.25943)
